<?php
  ...
  switch ($whois) {
    ...
    case 'sergey':
      ...
      $image = '../video/sergey.jpg';
      $starCount = array(5, 4, 5);
      break;
    case 'slava':
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-sm-4 col-12">
            <div class="modal-star__block">
              ...
              <div class="modal-star__stars">
                <?php for($i = 0; $i < 5; $i++) {
                  if($i<$starCount[0]) {
                    echo '<img src="img/train-offer/star-yellow.svg" alt="">';
                  } else {
                    echo '<img src="img/train-offer/star-grey.svg" alt="">';
                  }

                } ?>
              </div> <span class="modal-star__name-parameters">Выносливость</span>
              <div class="modal-star__stars">
                <?php for($i = 0; $i < 5; $i++) {
                  if($i<$starCount[1]) {
                    echo '<img src="img/train-offer/star-yellow.svg" alt="">';
              ...
              </div> <span class="modal-star__name-parameters">Чувство юмора</span>
              <div class="modal-star__stars">
                <?php for($i = 0; $i < 5; $i++) {
                  if($i<$starCount[2]) {
                    echo '<img src="img/train-offer/star-yellow.svg" alt="">';
          ...
          <div class="col-12">
            <div class="modal-star__block">
              ...
              <!--            <img src="img/train-offer/bg-modal.jpg" alt="" class="modal-star__image"> --></div>
          </div>
        </div>
      </div>
    </div>
